...
// API base URL - choose depending on platform (web uses localhost, Android emulator uses 10.0.2.2)
final String kApiBaseUrl = kIsWeb ? 'http://localhost:3000' : 'http://10.0.2.2:3000';