...
class DogBreedExpert extends StatefulWidget {
  const DogBreedExpert({super.key});

  @override
  State<DogBreedExpert> createState() => _DogBreedExpertState();
}

class _DogBreedExpertState extends State<DogBreedExpert> {
  ...
  Future<void> _sendMessage() async {
    ...
    final systemPrompt =
        '''
Return a JSON object ONLY (no extra text) describing the requested dog breed. The JSON must include these keys (use empty string if data not available):
{
  "name",
  "scientific_name",
  "origin",
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        data['name']?.toString().toUpperCase() ?? 'UNKNOWN BREED',
                        style: TextStyle(
                          fontSize: 18,
                ...
                builder: (context, constraints) {
                  ...
                  return GridView.count(
                    ...
                    children: [
                      ...
                      _buildFactTile('Lifespan', data['lifespan'], Icons.timelapse, primaryColor),
                    ],
                  );
                },
              ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _buildMetricCard('Height', data['height'], Icons.height, primaryColor),
                  ),
                ],
              ),
              ...
              Column(
                children: [
                  ...
                  _buildInfoSection('Training', data['training'], Icons.school, primaryColor),
                  _buildInfoSection('Grooming', data['grooming'], Icons.clean_hands, primaryColor),
                  _buildInfoSection('Health Issues', data['health_issues'], Icons.health_and_safety, primaryColor),
                ],
              ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isUser ? primaryColor : backgroundColor,
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(0.08),
                  blurRadius: 6,
      ...
      body: SafeArea(
        child: Column(
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        Text(
                          'Get breed information instantly',
                          style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'I can tell you about temperament, care, health, and more for any breed.',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                              ...
                              Wrap(
                                ...
                                children: [
                                  _buildSuggestionChip('Golden Retriever', primaryColor),
                                  _buildSuggestionChip('German Shepherd', primaryColor),
                                  _buildSuggestionChip('French Bulldog', primaryColor),
                                  _buildSuggestionChip('Poodle', primaryColor),
                                  _buildSuggestionChip('Beagle', primaryColor),
                                  _buildSuggestionChip('Rottweiler', primaryColor),
                                ],
                              ),
                            ],
                          ),
            ...
            // Input Area - Responsive bottom bar
            Container(
              padding: EdgeInsets.fromLTRB(
                12,
                8,
